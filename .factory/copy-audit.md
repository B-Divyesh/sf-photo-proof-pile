...
| Free for 1,000 files; US$29 once for full libraries | 9 | Claim: free-scan-limit, licensed-scan-limit |
| Each group keeps its file locations, dates, sizes, and match details. | 11 | None |
