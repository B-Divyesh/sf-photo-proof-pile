...
| macOS and Windows builds are unsigned. | 6 | Signature disclosure |
| Your system will ask you to confirm the first launch. | 10 | Installation warning |
...
| An installable release | verified release |
