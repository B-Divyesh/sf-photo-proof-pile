...
Use **Check desktop downloads** on the website. The dialog offers packages only after Windows and macOS signature checks pass. It offers nothing when that proof is missing.
